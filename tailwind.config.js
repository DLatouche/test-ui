...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        childrenClose: `${topMenuHeight + paddingChildren}px ${paddingChildren}px ${paddingChildren}px ${sideMenuWidthClose + paddingChildren}px`,
        childrenOpen: `${topMenuHeight + paddingChildren}px ${paddingChildren}px ${paddingChildren}px ${sideMenuWidthOpen + paddingChildren}px`,
